          ...
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p className="hero-subtitle">
                Track time directly from your menu bar to GCal. Simple, fast, and always accessible. Zero bloat.
              </p>
              <div className="hero-actions">
                ...
                >
                  ...
                  {isDownloading ? `Downloading... ${downloadProgress}%` : 'Download for Mac'}
                </button>
              </div>
