  ...
  return (
    <header className={`header ${isScrolled ? 'scrolled' : ''}`}>
      <div className="header-content">
        ...
        <button 
          className={`header-download-btn ${isDownloading ? 'downloading' : ''}`}
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 842.32007 1000.0001" style={{ marginRight: '6px' }}>
          ...
          {isDownloading ? `${downloadProgress}%` : 'Download for Mac'}
        </button>
      </div>
    </header>
  );
